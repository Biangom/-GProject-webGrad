...
<div class="sidebar-fixed position-fixed">
    ...
    <div class="list-group list-group-flush">
        <a href="./index.php?page=index" 
            <?
            if($page=='index')
                echo "class='list-group-item active waves-effect'";
            else
                echo "class='list-group-item list-group-item-action waves-effect'";
            ?>
        >
        ...
        <a href="./index.php?page=userInfo"
            ...
            ?>      
        >
            <i class="fa fa-user mr-3"></i>User Infomation</a>
        <a href="./index.php?page=jacketInfo"
            <?
            if($page=='jacketInfo')
                echo "class='list-group-item active waves-effect'";
            else
        ...
        >
            <i class="fa fa-table mr-3"></i>Jacket Infomation</a>
